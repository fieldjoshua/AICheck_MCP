...
echo -e "${BOLD}${NEON_GREEN}╚═╝  ╚═╝╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝${NC}"
echo ""
echo -e "${BOLD}${NEON_GREEN}                        v7.2.0${NC}"
...
# Download core files
echo -e "${BLUE}Downloading AICheck v7.2.0...${NC}"
...
if grep -q "7.0.0" aicheck.new; then
    echo -e "${GREEN}✓ Downloaded AICheck v7.2.0${NC}"
else
